...
<ul class="breadcrumb">
		<li>
			<i class="icon-home"></i>
			<a href="javascript:void(0)"><tiles:getAsString name="content.home"></tiles:getAsString> </a> 
			<i class="icon-angle-right"></i>
		</li>
		<li><a href="javascript:void(0)"><tiles:getAsString name="content.page.title"></tiles:getAsString></a></li>
	</ul>
